...
from neutral_coupling.common.eirene_input_parser import EireneInputParser, ValidationReport


INPUT_FILE = Path(__file__).parents[1] / "test_data" / "eirene_data" / "input.dat"
