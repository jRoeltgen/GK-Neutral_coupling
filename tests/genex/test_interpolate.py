...
from neutral_coupling.genex_coupling.interpolate import (
    interp_moments,
    interpolate_source,
...
def test_interpolate_all_sources_dispatch_and_structure():
    ...
    with patch(
        "neutral_coupling.genex_coupling.interpolate.interpolate_source",
        return_value=dummy,
    ) as mock_interp:
...
@patch("neutral_coupling.genex_coupling.interpolate.griddata")
