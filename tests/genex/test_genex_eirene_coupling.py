...
from neutral_coupling.genex_coupling.genex_eirene_coupling import (interpolate_all_moments,
...
def test_get_genex_electron_name_none():
    from neutral_coupling.genex_coupling.genex_eirene_coupling import get_genex_electron_name
...
def test_interpolate_all_moments_indices(monkeypatch):
    ...
    monkeypatch.setattr("neutral_coupling.genex_coupling.genex_eirene_coupling.interp_moments", fake_interp)
...
def test_interpolate_wrapper_expands_mask_and_renames_electrons(monkeypatch):
    ...
    monkeypatch.setattr(
        "neutral_coupling.genex_coupling.genex_eirene_coupling.interpolate_all_sources",
...
def test_temperature_interpolation_reuses_direct_values(monkeypatch):
    ...
    monkeypatch.setattr(
        "neutral_coupling.genex_coupling.genex_eirene_coupling.interpolate_source", interpolate
    )
